...
Tagged images of recent past releases are available. The last ones (at time of writing) are for GDAL 3.12.3 and PROJ 9.8.0, for linux/amd64 and linux/arm64:
* ghcr.io/osgeo/gdal:alpine-small-3.12.3
* ghcr.io/osgeo/gdal:alpine-normal-3.12.3
* ghcr.io/osgeo/gdal:ubuntu-small-3.12.3
* ghcr.io/osgeo/gdal:ubuntu-full-3.12.3
